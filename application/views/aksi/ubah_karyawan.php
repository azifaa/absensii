            ...
            <div class="activity">
                ...
                <div class="activity-data">
                    ...
                    <div class="card w-100 m-auto p-3">
                        <h3 class="text-center">Ubah Karyawan </h3>
                        <?php foreach ($user as $karyawan) : ?>
                        <form method="post" action="<?php echo base_url('admin/aksi_ubah_siswa') ?>"
                            enctype="multipart/form_data">
                            <input name="id_karyawan" type="hidden" value="<?php echo $karyawan->id_karyawan ?>">
                            <div class="mb-3">
                                <label for="nama" class="form-label">Username</label>
                                <input type="text" class="form-control" id="username" name="username"
                                    value="<?php echo $karyawan->username ?>">
                            </div>
                            <div class="mb-3">
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama Depan</label>
                                    <input type="text" class="form-control" id="nama_depan" name="nama_depan"
                                        value="<?php echo $karyawan->nama_depan ?> ">
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_belakang" name="nama_belakang"
                                        value="<?php echo $karyawan->nama_belakang ?> ">
                                </div>
                            </div>
                            ...
                            <div class="flex justify-content-between">
                                <div>
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary" name=" submit">Confirm</button>
                                </div>
                            </div>
