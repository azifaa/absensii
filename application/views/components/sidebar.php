    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links" style="padding-left:16px;">
                ...
                <li><a href="<?php echo base_url('admin/detail_karyawan') ?>">
                        <i class="fa-solid fa-clock-rotate-left"></i>

                        <span class="link-name">Detail Karyawan</span>
                    </a></li>
                <li><a href="<?php echo base_url('admin/karyawan') ?>">
                ...
                <li><a href="<?php echo base_url('admin/akun') ?>">
